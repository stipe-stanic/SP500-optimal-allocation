...
from .utils.custom_hub import competition_download, datasets_download
...
class DownloadCompetitionDatasetSettings(BaseModel): # type: ignore
    """
...
class DownloadDatasetSettings(BaseModel):
    """
...
@app.command()
def datasets(settings: DownloadDatasetSettings) -> None:
    """
